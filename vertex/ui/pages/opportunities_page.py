    ...
    (function(){
      ...
      if(mcEl&&bs.p05!=null&&bs.p95!=null&&VXCharts.card){
        ...
        VXCharts.card('op-sel-mc',{title:'Dispersion Monte-Carlo',
          ...
          explain:{shows:'La fourchette de rendement simulée sur l’horizon du plan : pessimiste (P05), médian (P50), optimiste (P95).',
            why:'Elle situe le rapport risque/récompense au-delà d’un seul objectif : probabilité d’atteindre TP1 avant de toucher le stop.',
            confirm:'Médiane positive et probabilité de TP1-avant-stop nettement supérieure à celle du stop.',
            invalidate:'P05 profondément négatif ou stop plus probable que TP1 — asymétrie défavorable. Estimation de modèle.'},
