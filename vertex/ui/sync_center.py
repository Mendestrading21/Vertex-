...
;(function(){
 ...
 +'#vxsc button:hover{border-color:rgba(255,255,255,.5)}'
 +'#vxsc button.pri{background:linear-gradient(135deg,#dbe1e8,#dbe1e8);color:#0b0b0b;border:none;font-weight:800}'
