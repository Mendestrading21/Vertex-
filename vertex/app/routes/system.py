...
_SW_JS = r"""
const CACHE='td-shell-v40';   // v40 : audit multi-pages — cross-asset marchés, scénarios options (heatmap/theta/IV), entonnoir/donuts, honnêteté verdicts & purge vert-marque/orange
