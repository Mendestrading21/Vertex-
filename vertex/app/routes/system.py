...
_SW_JS = r"""
const CACHE='td-shell-v63';   // v63 (COULEURS SÉMANTIQUES) : accents vert/rouge/jaune/violet/cyan enrichis (verdicts, statuts watchlist, greeks/IV violet, win-rates, breadth macro, qualité dégradée) — identité neutre + fond sombre inchangés
