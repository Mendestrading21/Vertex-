...
_SW_JS = r"""
const CACHE='td-shell-v58';   // v58 : /opportunities = SCREENER complet (filtres globaux, nuage avantage×proba, table triable, options enrichies, vue portefeuille×moteur)
