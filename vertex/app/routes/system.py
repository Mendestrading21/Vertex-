...
_SW_JS = r"""
const CACHE='td-shell-v41';   // v41 : audit passe 2 — coût/action & alertes serveur corrigés, fraîcheur réelle, nouveaux graphes (breadth trend, movers, R:R, P&L), a11y clavier/sr-only
