...
_SW_JS = r"""
const CACHE='td-shell-v61';   // v61 : Hyper Visual F1 — tokens macro/teal + neutres (sand/steel/stone/plum), échelle typo étendue, grilles 12 col .vx-span/.vx-grid-N, skeletons enrichis, palette macroSeries
