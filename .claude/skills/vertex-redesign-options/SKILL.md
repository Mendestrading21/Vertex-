...
description: Planifier puis exécuter la refonte Black Glass de l’espace Options dans Vertex.
...
- route : `/options`
- fichier principal : `vertex/ui/pages/options_intel_page.py`

## Mission

Refondre overview, volatility, radar, scenarios et events avec une lecture professionnelle de la convexité, IV, liquidité, risque événement et stratégies multi-jambes.
