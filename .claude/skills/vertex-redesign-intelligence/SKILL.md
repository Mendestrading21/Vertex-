...
description: Planifier puis exécuter la refonte Black Glass de l’espace Intelligence dans Vertex.
...
- route : `/intelligence`
- fichier principal : `vertex/ui/pages/intelligence_page.py`

## Mission

Clarifier analyst, committee, strategy, impacts, research et memory, en séparant moteurs déterministes, IA explicative, mémoire et validation humaine.
