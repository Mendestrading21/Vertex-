...
- [ ] Audit de la page documenté dans le rapport du lot sous `docs/vertex-v4/`.
...
## Design & composants
- [ ] Respecte les tokens (`--vx-*`) — zéro couleur en dur ; prism=marque, vert/rouge/ambre=sémantique, bleu=comparaison rare.
