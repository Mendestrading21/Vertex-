...
Le contrat du dépôt est explicite (`test_sw_cache_scope` le dit dans son
...
Usage :
    python tools/audit/bump_sw.py "motif du bump, en une phrase"
"""
...
EMPREINTE_TEST = RACINE / 'tests' / 'test_sw_cache_scope.py'
GARDIENS_BODY = ('tests/test_design_system_page.py',
