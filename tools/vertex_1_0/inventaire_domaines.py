...
Usage : python tools/vertex_1_0/inventaire_domaines.py [--temoin] [--md CHEMIN]
"""
import argparse
import ast
import os
...
def _rendre(inv):
    l = []
    a = l.append
    a('# Vertex 1.0 · #783 — Carte des domaines dupliqués')
    a('')
    a('SHA : `%s` · généré par `tools/vertex_1_0/inventaire_domaines.py`' % inv['sha'])
    a('')
