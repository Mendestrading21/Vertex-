...
Usage :
    python tools/vertex_1_0/inventaire_runtime.py [--temoin] [--json CHEMIN]
"""
import argparse
import ast
import json
...
def _rendre(inv):
    ...
    lignes = []
    a = lignes.append
    a('# Vertex 1.0 · #779 — Inventaire exécutable du runtime')
    a('')
    a('SHA : `%s` · généré par `tools/vertex_1_0/inventaire_runtime.py`' % inv['sha'])
    a('')
