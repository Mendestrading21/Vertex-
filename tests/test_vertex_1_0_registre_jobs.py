"""Vertex 1.0 · #779/G1 — LE REGISTRE DE JOBS NE DÉCLARE PLUS CE QU'IL N'A PAS.
...
`tools/vertex_1_0/mesurer_registre_jobs.py` énumère à l'AST **tous** les appels
...
from tools.vertex_1_0 import mesurer_registre_jobs as _mes  # noqa: E402
