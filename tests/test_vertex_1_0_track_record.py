"""Vertex 1.0 · #783/G3 — LE MOTEUR NE SE NOTAIT PAS.
...
from tools.vertex_1_0 import mesurer_track_record as _mes  # noqa: E402
...
def test_la_fixture_historique_ressemble_a_la_production():
    ...
    src = RACINE.joinpath('tests/test_track_record_lot89.py').read_text(
        encoding='utf-8')
