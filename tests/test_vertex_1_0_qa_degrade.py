"""Vertex 1.0 · G4/G6 — MODES DÉGRADÉS, SYMBOLE INCONNU, FUITE DE SECRET.

Ce fichier garde `tools/vertex_1_0/mesurer_qa_degrade.py`. Les contrôles y sont
...
from tools.vertex_1_0 import mesurer_qa_degrade as _mes  # noqa: E402
