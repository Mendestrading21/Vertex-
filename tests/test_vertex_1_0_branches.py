"""Vertex 1.0 · #782 — CLASSIFICATION DES 697 BRANCHES, SANS RIEN SUPPRIMER.

`CLEANUP_POLICY.md` interdit toute suppression sans **preuve de non-usage**.
`tools/vertex_1_0/mesurer_branches.py` produit cette preuve, branche par
...
from tools.vertex_1_0 import mesurer_branches as _mes  # noqa: E402
