"""Vertex 1.0 · G5 — éprouver le banc de la première connexion, sans broker.
...
from tools.vertex_1_0 import mesurer_g5_live as g5
...
def test_l_outil_n_ecrit_aucun_verbe_d_ordre_en_clair():
    ...
    src = (RACINE / 'tools/vertex_1_0/mesurer_g5_live.py').read_text(encoding='utf-8')
