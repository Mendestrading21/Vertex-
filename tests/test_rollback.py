"""Vertex Test 1.0 · G6 — le comparateur de bureaux, et rien de plus.
...
- **il ne garde pas** la mesure opérationnelle elle-même — créer un arbre de
  ...
  le rapport de rollback G6 (archive, retiree du depot), avec sa date et son SHA.
...
from tools.mesures.mesurer_rollback import comparer_bureaux

RACINE = pathlib.Path(__file__).resolve().parents[1]
OUTIL = RACINE / 'tools/mesures/mesurer_rollback.py'
