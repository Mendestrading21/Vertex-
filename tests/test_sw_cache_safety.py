"""tests/test_sw_cache_safety.py — gardien de sécurité du cache service worker.

Récupéré de la RC1 (commit 28d1e4e, absent de la lignée Neon Glass — voir
l audit de convergence de branches (archive, retiree du depot) §3.1/§7.1) et adapté : l'assertion de
