"""Vertex Test 1.0 · G2 — le balayage des surfaces creuses, et ses propres pièges.
...
from tools.mesures.mesurer_surfaces_vides import (
...
def test_le_corpus_vient_de_la_table_de_routage():
    ...
    src = (pathlib.Path(__file__).resolve().parents[1]
           / 'tools/mesures/mesurer_surfaces_vides.py').read_text(encoding='utf-8')
