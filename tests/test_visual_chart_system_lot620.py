...
THEME = ROOT / 'vertex/static/vertex/js/charts/chart-theme.js'
...
vm.runInThisContext(fs.readFileSync('vertex/static/vertex/js/charts/chart-theme.js', 'utf8'), {filename:'theme.js'});
